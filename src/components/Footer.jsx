...
const Footer = () => {
	return (
		<footer className="flex bg-brandSecondary flex-col text-left md:text-center gap-2 text-white mt-[9rem]">
			<div className="footer-grid w-[85%] mx-auto xl:w-[80%] grid justify-between pt-5 pb-8 md:grid-cols-4 md:gap:4 md:text-left md:px-4 md:place-items-center md:pl-[2.7rem] footer-wrapper">
				<div className="logo-text space-y-3 md:p-0 md:place-self-start md:flex md:flex-col md:gap-[3rem]">
					<a href="">
						<img src="/images/footer-logo-sm.png" alt="logo" className="" />
					</a>
					<p className="footer-copy text-[0.5rem] lg:w-[60%] lg:text-base">
